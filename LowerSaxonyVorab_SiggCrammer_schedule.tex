...
The goal of the next workpackage (WP-2) is to build a sensing system and infrastructure for collecting data. We estimate the effort required for this part by 5 quarters, divided into five stages, and performed in both institutes.
