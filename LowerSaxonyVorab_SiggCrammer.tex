...
Building on previous work, we will design features and classifiers for the detection of sentiment from EMG and EOG data.
...
\noindent
We will in this workpackage indentify suitable features for the prediction of sentiment from body and smartphone sensors. 
In particular, building on previous work regarding movement, gestures and pose as indicators of emotion, classifiers for the detection of such classes will be developed and linked to the classification of sentiment. 
In addition, building on the results from WP-4.1 we will investigate correlations between sensor readings of medical and acceleration sensors in order to give an estimation to which extent medical sensors can be substituted by cheaper acceleration sensors for the application in large scale sensing applications.  
